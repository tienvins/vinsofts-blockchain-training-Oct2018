...
module.exports = {
   ...
   choseNumber: async function choseNumber(address_to, int_value, privateKey) { // gui tien cho 1 tai khoan
      var rs = await getRaw(privateKey);
      var methodData = await myContract.methods.ChonSo(address_to).encodeABI();
      var rawTx = {
