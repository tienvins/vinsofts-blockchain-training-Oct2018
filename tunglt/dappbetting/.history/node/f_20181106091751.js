...
const link     = "https://ropsten.infura.io/v3/79cbd8b8559f4ec1a9bbd610a8952077";
...
module.exports = {
   ...
   sendToken: async function sendToken(address_to, int_value, privateKey) { // gui tien cho 1 tai khoan
      ...
      var sendSignedTransaction = web3.eth.sendSignedTransaction('0x' + serializedTx.toString('hex'));
